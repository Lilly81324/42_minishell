...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/11 17:56:52 by sikunne           #+#    #+#             */
/*   Updated: 2025/02/11 18:04:25 by sikunne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// returns either 0 if yes
// or returns 1 if no
static int	ft_check_access(char **paths, char *name)
{
	int		i;
	int		exists;
	int		acces;
...
char	*ft_check_cmd(char **envp, char *cmd)
{
	...
	status = ft_check_access(paths, cmd);
	free(cmd);
